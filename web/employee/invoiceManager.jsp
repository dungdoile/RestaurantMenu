...
<html>
    ...
    <body>
        ...
        <div class="displayCenter">
            <form action="<%=request.getContextPath()%>/employee/invoicemanager" method="post">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${requestScope.listOfInvoices}" var="i">
                                <tr>
                                    ...
                                    <td>${i.netPrice}</td>
                                    <td><a href="<%=request.getContextPath()%>/employee/invoicemanager?action=viewdetails&id=${i.invoiceId}"><button>View details</button></a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    <!-- List of invoice requests, create invoice -->
                    </body>
                    </html>
