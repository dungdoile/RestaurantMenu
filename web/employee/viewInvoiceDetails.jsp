...
<html>
    ...
    <body>
        ...
        <div class="form-add">
            ...
            <c:if test="${tableId!=null}"><p>Table: ${tableId}</p></c:if>
            ...
            <table>
                ...
                <c:forEach items="${invoiceDetails}" var="i">
                    <tr>
            ...
            <c:if test="${requestScope.action!=null && requestScope.action=='confirminvoicerequest'}">
                <a href="<%=request.getContextPath()%>/employee/tablemanager?action=confirminvoicerequest&tableId=${tableId}">
